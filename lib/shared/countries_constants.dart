class CountriesConstants {
  static List<String> getCountryLabels(List<String> selectedCountryCodes) {
    return CountriesConstants.nationality
        .where((country) => !selectedCountryCodes.contains(country['code']))
  ...
  static String getCountryCodeFromLabel(String label) {
    return CountriesConstants.nationality
        .firstWhere((country) => country['label'].toString() == label)['code']
        .toString();
  }
